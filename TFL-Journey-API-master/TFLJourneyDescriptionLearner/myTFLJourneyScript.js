        ...
        if (myRequest.readyState == 4 && myRequest.status == 200) {
            ...
            switch(choiceOption) {
                ...
                default:
                    ...
                    document.getElementById("myGoogleMap").setAttribute("src", "https://www.google.com/maps/embed/v1/directions?key= &origin="+getDepPC+"&destination="+getArrPC+"&mode=driving");
